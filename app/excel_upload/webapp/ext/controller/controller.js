...
sap.ui.define([
    ...
    function calltoUpload(oEvent,sStat,uploadResponse){
     ...
     var oExcelList = oModel.bindList("/Customers");
       ...
       */
        onUploadPress: function (oEvent) {
           // MessageToast.show("triggered");
            ...
            var aFragment = "com.alihaydarsayar.excelupload.ext.fragment.UploadExcel";
         ...
         */
         onUpload : function(oEvent){
            ...
            var aFileUploader = sap.ui.getCore().byId("com.alihaydarsayar.excelupload::CustomersList--uploader");
            //Represents a parameter for the FileUploader which is rendered as a hidden inputfield.
            var headerPar = new sap.ui.unified.FileUploaderParameter();
            headerPar.setName('slug');
            headerPar.setValue("Customers");
